define('app',['exports'], function (exports) {
    ...
    var App = exports.App = function () {
        ...
        App.prototype.configureRouter = function configureRouter(config, router) {
            ...
            config.map([{ route: ['', 'home'], name: 'home', moduleId: 'home/home', title: 'Home' }, { route: 'simple', name: 'simple', moduleId: 'simple/simple', title: 'Free text', nav: true }, { route: 'facets', name: 'facets', moduleId: 'facets/facets', title: 'Faceted', nav: true }, { route: 'location', name: 'location', moduleId: 'location/location', title: 'Location based', nav: true }]);
        };
...
define('text!home/home.html', ['module'], function(module) { module.exports = "<template>\n    <require from=\"./home.css\"></require>\n\n    <div id=\"home\" class=\"container-fluid text-xs-center\">\n        <h1 class=\"title\">Azure Search Demo</h1>\n\n        <nav>\n            <ul class=\"nav nav-inline\">\n                <li repeat.for=\"row of router.navigation\" class=\"nav-item\">\n                    <a class=\"nav-link\" href.bind=\"row.href\">${row.title}</a>\n                </li>\n            </ul>\n        </nav>\n    </div>\n\n</template>"; });
define('text!home/home.css', ['module'], function(module) { module.exports = "#home {\n    height: 100%;\n    min-height: 100%;\n    min-height: 100vh;\n    background-image: url(\"content/beer.jpg\");\n    background-size: cover;\n    background-repeat: no-repeat;\n    color: #FFF;\n}\n\n.title {\n    font-family: montserrat;\n    padding-top: 30vh;\n    font-size: 4.5rem;\n    font-weight: bold;\n    text-transform: uppercase;\n}\n\n#home nav{\n    margin: 30px 0;\n}\n\n#home .nav-link {\n    color: #fff;\n    border: 2px #FFF solid;\n    padding: 20px 40px;\n    margin: 20px;\n    text-transform: uppercase;\n    font-family: Raleway;\n    letter-spacing: 2px;\n}\n\n#home .nav-link:hover {\n    background-color: rgba(255,255,255,0.8);\n    transition: background-color 500ms linear;\n    transition: color 500ms linear;\n    color: #333;\n}"; });
